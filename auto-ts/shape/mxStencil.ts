 ...
 * @class
 */
export class mxStencil extends mxShape {
  /**
   Copyright (c) 2006-2015, JGraph Ltd
   Copyright (c) 2006-2015, Gaudenz Alder
   */
  ...
  drawShape(canvas, shape, x, y, w, h) {
    ...
    var sw = (this.strokewidth == 'inherit') ? Number(mxUtils.getNumber(shape.style, mxConstants.STYLE_STROKEWIDTH, 1)) : Number(this.strokewidth) * minScale;

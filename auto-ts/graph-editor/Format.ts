...
FormatState = function () {
  ...
  this.style = {}; // {}
  this.containsImage = false; // boolean
  this.containsLabel = false; // boolean
  this.fill = false; // boolean
  this.glass = false; // boolean
  this.rounded = false; // boolean
  this.comic = false; // boolean
  this.autoSize = false; // boolean
  this.image = false; // boolean
  this.shadow = false; // boolean
  this.lineJumps = false; // boolean
};
 ...
 * @param max {number}
 * @param unit {string}
 * @param textEditFallback {function}
 ...
 * @param defaultValue {string}
 * @param enabledValue {string}
 * @param disabledValue {string}
 * @param action {Action}
 * @param stopEditing {function}
 * @returns {HTMLElement}
 */
 ...
 * @param styleElem {HTMLStyleElement}
...
/**
 * Adds the label menu items to the given menu and parent.
 * @returns {Array.<{title: string, key: string, defaultValue: string}>}
 */
